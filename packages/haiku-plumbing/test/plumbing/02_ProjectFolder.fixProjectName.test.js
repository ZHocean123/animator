...
tape("ProjectFolder.fixProjectName", test => {
  ...
  TestHelpers.setup(function(folder, creator, glass, timeline, teardown) {
    ...
    fse.writeFileSync(
      path.join(folder, "Hello.svg"),
      '<svg><rect x="0" y="0" stroke="1" fill="black"></rect></svg>'
    );
    return async.series(
      [
        function(cb) {
