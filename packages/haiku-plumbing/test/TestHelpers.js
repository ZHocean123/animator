...
import * as randomAlphabetical from "haiku-serialization/src/utils/randomAlphabetical.js";
...
function plumb(cb) {
  ...
  return plumbing.launch(
    { mode: "headless" },
    (err, host, port, server, spawned, envoy) => {
      if (err) {
        throw err;
      }
