 ...
 */
var canUseShorthand = function (obj, keyChain) {
...
var objectToOAST = function (obj, keyChain) {
    ...
    for (var key in obj) {
        ...
        keyChain.push(key);
        var valueexp = expressionToOASTComponent(obj[key], key, keyChain);
        keyChain.pop();
...
//# sourceMappingURL=objectToOAST.js.map