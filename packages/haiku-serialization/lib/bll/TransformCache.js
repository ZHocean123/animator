var TransformCache = /** @class */ (function () {
    function TransformCache(host) {
        this.host = host;
        this.cache = {};
    }
    /**
     ...
     */
    TransformCache.prototype.set = function (key) {
        var transform = this.host.getComputedLayout();
    ...
    TransformCache.prototype.get = function (key) {
        return this.cache[key];
    };
    return TransformCache;
}());
module.exports = TransformCache;
//# sourceMappingURL=TransformCache.js.map