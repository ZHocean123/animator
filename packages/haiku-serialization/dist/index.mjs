...
var require_parseCode = /* @__PURE__ */ __commonJS({ "src/ast/parseCode.js": ((exports, module) => {
	const { parse: parse$3 } = __require("@babel/parser");
...
var require_wrapInHaikuInject = /* @__PURE__ */ __commonJS({ "src/ast/wrapInHaikuInject.js": ((exports, module) => {
	const { toText } = __require("@haiku/core/lib/reflection/JavaScriptIdentifier");
...
var require_functionBodyStringToFunctionBodyAST = /* @__PURE__ */ __commonJS({ "src/ast/functionBodyStringToFunctionBodyAST.js": ((exports, module) => {
	const { parse: parse$2 } = __require("@babel/parser");
...
var require_objectToOAST = /* @__PURE__ */ __commonJS({ "src/ast/objectToOAST.js": ((exports, module) => {
	const { LAYOUT_3D_SCHEMA: LAYOUT_3D_SCHEMA$2 } = __require("@haiku/core/lib/HaikuComponent");
	/**
...
var require_generateCode = /* @__PURE__ */ __commonJS({ "src/ast/generateCode.js": ((exports, module) => {
	const generate = __require("@babel/generator").default;
...
var require_traverseAST = /* @__PURE__ */ __commonJS({ "src/ast/traverseAST.js": ((exports, module) => {
	const traverse = __require("@babel/traverse").default;
...
var require_Logger = /* @__PURE__ */ __commonJS({ "src/utils/Logger.js": ((exports, module) => {
	const EventEmitter$6 = __require("node:events");
	const path$18 = __require("node:path");
	const jsonStringify = require_fast_safe_stringify();
	const { isProduction, isWindows: isWindows$2 } = __require("haiku-common");
...
var require_LoggerInstance = /* @__PURE__ */ __commonJS({ "src/utils/LoggerInstance.js": ((exports, module) => {
	const fs$3 = __require("haiku-fs-extra");
...
var require_parseExpression = /* @__PURE__ */ __commonJS({ "src/ast/parseExpression.js": ((exports, module) => {
	const Parser = __require("cst").Parser;
	const walk = __require("estree-walker").walk;
...
var require_reifyOAST = /* @__PURE__ */ __commonJS({ "src/ast/reifyOAST.js": ((exports, module) => {
	...
	const reifyRO$2 = __require("@haiku/core/lib/reflection/reifyRO").default;
...
var require_CryptoUtils = /* @__PURE__ */ __commonJS({ "src/utils/CryptoUtils.js": ((exports, module) => {
	...
	const realSha256 = __require("crypto-js/sha256");
...
var require_EmitterManager = /* @__PURE__ */ __commonJS({ "src/utils/EmitterManager.js": ((exports, module) => {
	const { EventEmitter: EventEmitter$5 } = __require("node:events");
...
var require_DiskStorage = /* @__PURE__ */ __commonJS({ "src/bll/storage/DiskStorage.js": ((exports, module) => {
	const path$17 = __require("node:path");
	const fse$7 = __require("haiku-fs-extra");
...
var require_BaseModel = /* @__PURE__ */ __commonJS({ "src/bll/BaseModel.js": ((exports, module) => {
	const { EventEmitter: EventEmitter$4 } = __require("node:events");
	...
	const expressionToRO$4 = __require("@haiku/core/lib/reflection/expressionToRO").default;
	const reifyRO$1 = __require("@haiku/core/lib/reflection/reifyRO").default;
...
var require_overrideModulesLoaded = /* @__PURE__ */ __commonJS({ "src/utils/overrideModulesLoaded.js": ((exports, module) => {
	...
	const nodehook = __require("node-hook");
...
var require_Template = /* @__PURE__ */ __commonJS({ "src/bll/Template.js": ((exports, module) => {
	...
	const { ATTRS_HYPH_TO_CAMEL } = __require("@haiku/core/lib/HaikuComponent");
	const find = __require("lodash.find");
	const merge$1 = __require("lodash.merge");
	const pascalcase$1 = __require("pascalcase");
	const SVGPoints = __require("@haiku/core/lib/helpers/SVGPoints").default;
	const { visitManaTree } = __require("@haiku/core/lib/HaikuNode");
	const { default: convertManaLayout$1 } = __require("haiku-common");
	const { manaToXml } = __require("haiku-common");
	const assign = __require("lodash.assign");
	const defaults = __require("lodash.defaults");
...
var require_ModuleWrapper = /* @__PURE__ */ __commonJS({ "src/bll/ModuleWrapper.js": ((exports, module) => {
	...
	const CANONICAL_CORE_SOURCE_CODE_PATH = path$14.dirname(__require.resolve("@haiku/core"));
	...
	const CORE_VERSION = __require(path$14.join(CANONICAL_CORE_SOURCE_CODE_PATH, "package.json")).version;
	const MODULE_CACHE_HOT = {};
	const MODULE_CACHE_COLD = {};
	const Module = __require("node:module");
	const haikuCore = __require("@haiku/core");
	...
	*/
	var ModuleWrapper$7 = class ModuleWrapper$7 extends BaseModel$23 {
		...
		getAbspath() {
			if (this.isExternalModule) return __require.resolve(this.getModpath());
		...
		load() {
			overrideModulesLoaded$1((stop) => {
				...
				this.exp = __require(this.getAbspath());
	...
	*/
	...
	ModuleWrapper$7.clearRequireCache = (dirname) => {
		const cleared = {};
		for (const key in __require.cache) if (dirname) {
...
var require_Expression = /* @__PURE__ */ __commonJS({ "src/bll/Expression.js": ((exports, module) => {
	const { tokenizeDirective } = __require("@haiku/core/lib/reflection/Tokenizer");
...
var require_State = /* @__PURE__ */ __commonJS({ "src/bll/State.js": ((exports, module) => {
	...
	const ReservedWords = __require("@haiku/core/lib/reflection/ReservedWords").default;
...
var require_Bytecode = /* @__PURE__ */ __commonJS({ "src/bll/Bytecode.js": ((exports, module) => {
	const lodash$4 = __require("lodash");
	const clone$1 = require_lodash();
	const cloneDeepWith = __require("lodash.clonedeepwith");
	const merge = __require("lodash.merge");
	const BaseModel$20 = require_BaseModel();
	const enhance = __require("@haiku/core/lib/reflection/enhance").default;
...
var require_fileManipulation = /* @__PURE__ */ __commonJS({ "src/utils/fileManipulation.js": ((exports, module) => {
	const { exec: exec$1 } = __require("node:child_process");
...
var require_Figma = /* @__PURE__ */ __commonJS({ "src/bll/Figma.js": ((exports, module) => {
	const path$13 = __require("node:path");
...
var require_Illustrator = /* @__PURE__ */ __commonJS({ "src/bll/Illustrator.js": ((exports, module) => {
	const { execSync: execSync$1 } = __require("node:child_process");
	const os$1 = __require("node:os");
	const path$12 = __require("node:path");
	const { isMac: isMac$2, isWindows: isWindows$1 } = __require("haiku-common");
	const fse$5 = __require("haiku-fs-extra");
...
var require_MathUtils = /* @__PURE__ */ __commonJS({ "src/bll/MathUtils.js": ((exports, module) => {
	const pointInPolygon = __require("point-in-polygon");
...
var require_sketchUtils = /* @__PURE__ */ __commonJS({ "src/utils/sketchUtils.js": ((exports, module) => {
	...
	const { isMac: isMac$1 } = __require("haiku-common");
...
var require_Sketch = /* @__PURE__ */ __commonJS({ "src/bll/Sketch.js": ((exports, module) => {
	...
	const path$10 = __require("node:path");
	const fse$4 = __require("haiku-fs-extra");
	const { PNG } = __require("pngjs");
...
var require_Property = /* @__PURE__ */ __commonJS({ "src/bll/Property.js": ((exports, module) => {
	const { getFallback } = __require("@haiku/core/lib/HaikuComponent");
	const decamelize$1 = __require("decamelize");
	const { Experiment: Experiment$6, experimentIsEnabled: experimentIsEnabled$6 } = __require("haiku-common");
	const titlecase$1 = __require("titlecase");
...
var require_ElementSelectionProxy = /* @__PURE__ */ __commonJS({ "src/bll/ElementSelectionProxy.js": ((exports, module) => {
	...
	const { default: HaikuElement$1 } = __require("@haiku/core/lib/HaikuElement");
	const { default: Layout3D$2 } = __require("@haiku/core/lib/Layout3D");
	const { default: composedTransformsToTimelineProperties$1 } = __require("haiku-common");
	const { Experiment: Experiment$5, experimentIsEnabled: experimentIsEnabled$5 } = __require("haiku-common");
	const { default: invertMatrix } = __require("haiku-vendor-legacy/lib/gl-mat4/invert");
	const lodash$3 = __require("lodash");
...
var require_Keyframe = /* @__PURE__ */ __commonJS({ "src/bll/Keyframe.js": ((exports, module) => {
	const HaikuComponent$1 = __require("@haiku/core/lib/HaikuComponent").default;
	const expressionToRO$2 = __require("@haiku/core/lib/reflection/expressionToRO").default;
	const Curve = __require("@haiku/core/lib/api").Curve;
	const { isDecomposableCurve, getCurveInterpolationPoints } = __require("haiku-formats");
...
var require_Element = /* @__PURE__ */ __commonJS({ "src/bll/Element.js": ((exports, module) => {
	const lodash$2 = __require("lodash");
	const HaikuElement = __require("@haiku/core/lib/HaikuElement").default;
	const Layout3D$1 = __require("@haiku/core/lib/Layout3D").default;
	const { cssQueryTree } = __require("@haiku/core/lib/HaikuNode");
	const { default: composedTransformsToTimelineProperties } = __require("haiku-common");
	const functionToRFO = __require("@haiku/core/lib/reflection/functionToRFO").default;
	const { LAYOUT_3D_SCHEMA: LAYOUT_3D_SCHEMA$1 } = __require("@haiku/core/lib/HaikuComponent");
	const KnownDOMEvents = __require("@haiku/core/lib/renderers/dom/Events").default;
	const decamelize = __require("decamelize");
	const Matrix$1 = __require("gl-matrix");
	const { Experiment: Experiment$4, experimentIsEnabled: experimentIsEnabled$4 } = __require("haiku-common");
	const polygonOverlap = __require("polygon-overlap");
	const titlecase = __require("titlecase");
...
var require_Artboard = /* @__PURE__ */ __commonJS({ "src/bll/Artboard.js": ((exports, module) => {
	const Matrix = __require("gl-matrix");
...
var require_Asset = /* @__PURE__ */ __commonJS({ "src/bll/Asset.js": ((exports, module) => {
	const path$8 = __require("node:path");
	const { Experiment: Experiment$3, experimentIsEnabled: experimentIsEnabled$3, isMac, isWindows } = __require("haiku-common");
...
var require_AST = /* @__PURE__ */ __commonJS({ "src/bll/AST.js": ((exports, module) => {
	...
	const expressionToRO$1 = __require("@haiku/core/lib/reflection/expressionToRO").default;
	const { Experiment: Experiment$2, experimentIsEnabled: experimentIsEnabled$2 } = __require("haiku-common");
...
var require_haikuCollapseGroups = /* @__PURE__ */ __commonJS({ "src/svg/plugins/haikuCollapseGroups.js": ((exports) => {
	...
	const collections = __require("svgo/plugins/_collections");
...
var require_File = /* @__PURE__ */ __commonJS({ "src/bll/File.js": ((exports, module) => {
	...
	const fse$3 = __require("fs-extra");
	const { xmlToMana } = __require("haiku-common");
	const { debounce } = __require("lodash");
	const expressionToRO = __require("@haiku/core/lib/reflection/expressionToRO").default;
	const { bootstrapSceneFilesSync } = __require("@haiku/sdk-client");
...
var require_ActiveComponent = /* @__PURE__ */ __commonJS({ "src/bll/ActiveComponent.js": ((exports, module) => {
	...
	const { default: HaikuComponent, clone } = __require("@haiku/core/lib/HaikuComponent");
	const { LAYOUT_3D_SCHEMA } = __require("@haiku/core/lib/HaikuComponent");
	const { HAIKU_ID_ATTRIBUTE, HAIKU_LOCKED_ATTRIBUTE, HAIKU_TITLE_ATTRIBUTE, HAIKU_VAR_ATTRIBUTE } = __require("@haiku/core/lib/HaikuElement");
	const { PlaybackFlag } = __require("@haiku/core/lib/HaikuTimeline");
	const async$1 = __require("async");
	const jss$1 = __require("json-stable-stringify");
	const lodash$1 = __require("lodash");
	const pascalcase = __require("pascalcase");
	const pretty = __require("pretty");
	const HaikuDOMAdapter = __require("@haiku/core/lib/adapters/dom").default;
	const { InteractionMode: InteractionMode$1, isPreviewMode } = __require("@haiku/core/lib/helpers/interactionModes");
	const { getSortedKeyframes } = __require("@haiku/core/lib/helpers/KeyframeUtils");
	const Layout3D = __require("@haiku/core/lib/Layout3D");
	const { Experiment: Experiment$1, experimentIsEnabled: experimentIsEnabled$1 } = __require("haiku-common");
	...
	const SustainedWarningChecker = __require("haiku-common").SustainedWarningChecker;
...
var require_FontComponent = /* @__PURE__ */ __commonJS({ "src/bll/FontComponent.js": ((exports, module) => {
	...
	const BYTECODE = __require(MODPATH);
	/**
	* @class FontComponent
	*/
...
var require_BufferUtil = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/ws@3.2.0/node_modules/ws/lib/BufferUtil.js": ((exports, module) => {
	...
	*/
	...
	try {
		const bufferUtil$3 = __require("bufferutil");
...
var require_Project = /* @__PURE__ */ __commonJS({ "src/bll/Project.js": ((exports, module) => {
	...
	const { InteractionMode } = __require("@haiku/core/lib/helpers/interactionModes");
	const { getSafeProjectName, getProjectNameSafeShort, getDefaultIllustratorAssetPath, getDefaultSketchAssetPath, getReactProjectName, getProjectNameLowerCase, readPackageJson, getAngularSelectorName } = __require("@haiku/sdk-client");
	const async = __require("async");
	const { Experiment, experimentIsEnabled } = __require("haiku-common");
	const fse$2 = __require("haiku-fs-extra");
	const { EnvoyClient, EnvoyLogger, GLASS_CHANNEL } = __require("haiku-sdk-creator");
	const jss = __require("json-stable-stringify");
...
var require_filterWalkFolder = /* @__PURE__ */ __commonJS({ "src/utils/filterWalkFolder.js": ((exports, module) => {
	...
	const fse$1 = __require("haiku-fs-extra");
...
var require_Mixpanel = /* @__PURE__ */ __commonJS({ "src/utils/Mixpanel.js": ((exports, module) => {
	...
	const Mixpanel$1 = __require("mixpanel");
...
var require_walkFiles = /* @__PURE__ */ __commonJS({ "src/utils/walkFiles.js": ((exports, module) => {
	const fse = __require("haiku-fs-extra");
...
//#endregion
var AST = import_AST.default;
var ActionStack = import_ActionStack.default;
var ActiveComponent = import_ActiveComponent.default;
var Artboard = import_Artboard.default;
var Asset = import_Asset.default;
var BaseModel = import_BaseModel.default;
var Bytecode = import_Bytecode.default;
var Cache = import_Cache.default;
var Changelog = import_Changelog.default;
var CryptoUtils = import_CryptoUtils.default;
var DiskStorage = import_DiskStorage.default;
var Element = import_Element.default;
var ElementSelectionProxy = import_ElementSelectionProxy.default;
var EmitterManager = import_EmitterManager.default;
var Expression = import_Expression.default;
var Figma = import_Figma.default;
var File = import_File.default;
var FontComponent = import_FontComponent.default;
var HaikuHomeDir = import_HaikuHomeDir.default;
var Illustrator = import_Illustrator.default;
var ImageComponent = import_ImageComponent.default;
var InstalledComponent = import_InstalledComponent.default;
var Keyframe = import_Keyframe.default;
var Lock = import_Lock.default;
var Logger = import_Logger.default;
var LoggerInstance = import_LoggerInstance.default;
var MathUtils = import_MathUtils.default;
var MemoryStorage = import_MemoryStorage.default;
var Mixpanel = import_Mixpanel.default;
var MockWebsocket = import_MockWebsocket.default;
var ModuleWrapper = import_ModuleWrapper.default;
var MountElement = import_MountElement.default;
var Project = import_Project.default;
var Property = import_Property.default;
var PseudoFile = import_PseudoFile.default;
var Row = import_Row.default;
var SelectionMarquee = import_SelectionMarquee.default;
var Sketch = import_Sketch.default;
var State = import_State.default;
var Template = import_Template.default;
var Timeline = import_Timeline.default;
var TimelineProperty = import_TimelineProperty.default;
var TransformCache = import_TransformCache.default;
var Websocket = import_Websocket.default;
var ensureTrailingSlash = import_ensureTrailingSlash.default;
var fileManipulation = import_fileManipulation.default;
var filterWalkFolder = import_filterWalkFolder.default;
var getSvgOptimizer = import_getSvgOptimizer.default;
var overrideModulesLoaded = import_overrideModulesLoaded.default;
var randomAlphabetical = import_randomAlphabetical.default;
var requestElementCoordinates = import_requestElementCoordinates.default;
var serializeError = import_serializeError.default;
var sketchUtils = import_sketchUtils.default;
var toTitleCase = import_toTitleCase.default;
var walkFiles = import_walkFiles.default;
export { AST, ActionStack, ActiveComponent, Artboard, Asset, BaseModel, Bytecode, Cache, Changelog, CryptoUtils, DiskStorage, Element, ElementSelectionProxy, EmitterManager, Expression, Figma, File, FontComponent, HaikuHomeDir, Illustrator, ImageComponent, InstalledComponent, Keyframe, Lock, Logger, LoggerInstance, MathUtils, MemoryStorage, Mixpanel, MockWebsocket, ModuleWrapper, MountElement, Project, Property, PseudoFile, Row, SelectionMarquee, Sketch, State, Template, Timeline, TimelineProperty, TransformCache, Websocket, ensureTrailingSlash, fileManipulation, filterWalkFolder, getSvgOptimizer, overrideModulesLoaded, randomAlphabetical, requestElementCoordinates, serializeError, sketchUtils, toTitleCase, walkFiles };