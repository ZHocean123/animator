...
import convertManaLayout from 'haiku-common/lib/layout/convertManaLayout.mjs';
import { visitManaTree } from '@haiku/core/lib/HaikuNode.js';
import { manaToXml } from 'haiku-common/lib/layout/xmlUtils.mjs';
...
Template.visitManaTreeSpecial = function visitManaTreeSpecial(
  address,
  hash,
  mana,
  iteratee,
...
Template.getPropertyValue = (
  ...
  return bytecode.timelines[timelineName][`haiku:${componentId}`][propertyName][
    timelineTime
  ].value;
};
