...
export { Figma, FIGMA_DEFAULT_FILENAME, MAX_ITEMS_TO_IMPORT, PHONY_FIGMA_FILE }
export default { Figma, PHONY_FIGMA_FILE, FIGMA_DEFAULT_FILENAME, MAX_ITEMS_TO_IMPORT }
