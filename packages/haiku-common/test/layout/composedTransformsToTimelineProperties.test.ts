...
tape("composedTransformsToTimelineProperties", suite => {
  suite.test("normalizeRotationsInQuadrants", test => {
    ...
    test.deepEqual(
      out["rotation.z"],
      0,
      "without unrotated normalizer z rotation is 0"
    );
    ...
    test.deepEqual(
      out["rotation.z"],
      6.283,
      "with normalizer rotation is normalized"
    );
    ...
    test.deepEqual(
      out["rotation.z"],
      6.283,
      "normalizer can round up to positive on boundary"
    );
    ...
    test.deepEqual(
      out["rotation.z"],
      0,
      "normalizer can round up to 0 on boundary"
    );
    ...
    test.deepEqual(
      out["rotation.z"],
      -6.283,
      "normalizer can round up to negative on boundary"
    );
    ...
    test.deepEqual(
      out["rotation.z"],
      6.283,
      "normalizer can round down to positive on boundary"
    );
    ...
    test.deepEqual(
      out["rotation.z"],
      0,
      "normalizer can round down to 0 on boundary"
    );
    ...
    test.deepEqual(
      out["rotation.z"],
      -6.283,
      "normalizer can round down to negative on boundary"
    );
