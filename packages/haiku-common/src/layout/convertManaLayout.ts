...
function isNumericDefined(value: any): boolean {
  return typeof value === 'number'
}

function determineSizingProp(attributeValue: PrimitiveType) {
...
function fallbackSizeAbsolute(node: BytecodeNode, axis: string): number {
