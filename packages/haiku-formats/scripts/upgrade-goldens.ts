...
// @ts-ignore
import * as AST from "haiku-serialization/src/bll/AST.js";
import { join } from "path";

const goldensRoot = join(global.process.cwd(), "test/goldens");
const ast = AST.upsert({
  uid: "upgrader",
  file: { getImportPathTo: () => {} }
});
