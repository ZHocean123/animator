 ...
 * @param element
 */
function shimLayoutForPseudoElement(timeline: BytecodeTimelineProperties, element: { layout: LayoutSpec }) {
 ...
 */
function simplify3dTransformations(out: ComposedTransformSpec, epislon = 1e-3) {
 ...
 * @returns {{}}
 */
export function composeTimelines(shapeLayerSize: ThreeDimensionalLayoutProperty, childTimeline: any, parentTimeline: any) {
