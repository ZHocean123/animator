...
function getExporter(request: ExporterRequest, bytecode: HaikuBytecode, componentFolder: string): ExporterInterface {
...
export async function handleExporterSaveRequest(request: ExporterRequest, bytecode: HaikuBytecode, componentFolder: string): Promise<void> {
