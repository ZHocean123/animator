import { isNumeric, ModalFooter, ModalHeader, ModalWrapper, Palette, RevealPanel } from 'haiku-ui-common'
...
class EventHandlerEditor extends React.PureComponent {
  ...
  setupMonaco() {
    ...
    this.completionDisposer = monaco.languages.registerCompletionItemProvider('javascript', {
      provideCompletionItems(model, position) {
        ...
        const currentWord = textUntilPosition.match(/[a-z|.]+$/i)
  ...
  render() {
    ...
    return (
      <ModalWrapper
        style={{ ...visibilityStyles, ...STYLES.container }}
