...
import EventHandlerEditor from './components/EventHandlerEditor/index.jsx'
...
import ProxyHelpScreen from './components/ProxyHelpScreen.jsx'
import ProxySettingsScreen from './components/ProxySettingsScreen.jsx'
  ...
  render() {
    ...
    return (
      <div style={{ position: 'relative', width: '100%', height: '100%' }}>
        ...
        {this.state.dashboardVisible && this.envoyClient && this.envoyProject && this.state.username && (
          <ProjectBrowser
            ref={(ref) => { this.refs.ProjectBrowser = ref }}
        ...
        {!this.state.dashboardVisible && !this.state.doShowProjectLoader && this.state.projectModel && (
            ...
            <div className="layout-box" style={{ overflow: 'visible' }}>
              <SplitPanel split="horizontal" minSize={300} defaultSize="62vh">
                ...
                >
                  ...
                  >
                    <Timeline
                      ref={(ref) => { this.refs.timeline = ref }}
                      folder={this.state.projectFolder}
                      envoyClient={this.envoyClient}
                      haiku={this.props.haiku}
                      username={this.state.username}
