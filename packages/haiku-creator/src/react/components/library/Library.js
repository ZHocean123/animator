...
import { Figma, MAX_ITEMS_TO_IMPORT } from 'haiku-serializationbll/Figma'
import { didAskedForSketch } from 'haiku-serializationutils/HaikuHomeDir'
          ...
          this.props.createNotice({
            ...
            message: (
              <span>
                ...
                {' '}
                <ExternalLink style={{ textDecoration: 'underline' }} href="https://help.haikuforteams.com/troubleshooting/troubleshooting-figma-imports">article</ExternalLink>
                .
              </span>
            ),
          })
