import quat_1 from './lib/quat.js';
import identityModule from '../gl-mat4/identity.js';
import fromRotationTranslationModule from '../gl-mat4/fromRotationTranslation.js';
import scaleModule from '../gl-mat4/scale.js';
import multiplyModule from '../gl-mat4/multiply.js';
...
var mat4 = {
  ...
  fromRotationTranslation: fromRotationTranslationModule,
  scale: scaleModule,
...
var ONES = [1, 1, 1];
var tmpQuat = [0, 0, 0, 1];
var tmpMat4 = mat4.identity(new Float32Array(16));
