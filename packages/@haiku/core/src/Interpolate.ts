 ...
 */
import type { BytecodeStateType, CurveDefinition, CurveFunction } from './api'
...
export function interpolate(now: number, curve: CurveDefinition, started: number, ends: number, origin: BytecodeStateType, destination: BytecodeStateType): BytecodeStateType {
