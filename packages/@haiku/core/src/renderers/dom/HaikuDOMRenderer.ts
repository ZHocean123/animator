...
import type { IHaikuComponent, IRenderer, MountLayout } from '../../api'
...
function connectTarget(virtualNode, domElement) {
  if (virtualNode && typeof virtualNode === 'object') {
    ...
    if (!virtualNode.__memory.targets.includes(domElement)) {
...
function mixpanelInit(mixpanelToken, component) {
