...
// 2500: { value: { ... } }
// 5000: { value: { ... } }
function getKeyframesList(sorted: number[], nowValue: number) {
...
export function calculateValue(keyframeGroup: BytecodeTimelineProperty, nowValue: number, sortedKeyframes?: number[]) {
  if (!sortedKeyframes) {
