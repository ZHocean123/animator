  ...
  timelines: {
    Default: {
      ...
      'haiku:HaikuControlsSvgTextElement': {
        ...
        'alignment-baseline': {
          0: {
            value: inject((alignmentBaseline) => {
