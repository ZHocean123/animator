...
function replaceLodashReferences(content) {
  ...
  // 1. 替换 import * as lodash from 'lodash' → import * as lodash from 'lodash-es'
  ...
  // 2. 替换 import _ from 'lodash' → import _ from 'lodash-es'
  ...
  // 3. 替换 import * as _ from 'lodash' → import * as _ from 'lodash-es'
  ...
  // 4. 替换 import { functionName } from 'lodash' → import { functionName } from 'lodash-es'
  ...
  // 5. 替换 const _ = require('lodash') → import _ from 'lodash-es'
  ...
  // 6. 替换 const lodash = require('lodash') → import * as lodash from 'lodash-es'
  ...
  // 7. 替换 const { functionName } = require('lodash') → import { functionName } from 'lodash-es'
  ...
  // 8. 替换 require('lodash.functionName') → import { functionName } from 'lodash-es'
